...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="expert-content" style=" display: grid; grid-template-columns: repeat(1, 1fr);">
           ...
           <div id="spacer-modal-two" class="spacer-modal">
                <p id="Choose-a-Time">Choose an Expert</p>
...
<div class="container">
   ...
   <div class="consultation-fee-box">
    ...
    <div class="book-now-section" style="left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
        <div class="booking-btn-container">
            <center>
            <p style="font-size:12px"><i>To book this service you must first book a consultation*</i></p>
            </center>
            <div class="book-now-container" style="display: flex;
    justify-content: center;"><button class="book-now" onclick="openCalendar()">Continue</button></div>
        </div>
