...
$_SESSION['login_redirection_url'] = 'book-now-max-discount.php?cunique=' . $cunique . '&id=' . $cid . '&keydate=' . $keydate . '&keytime=' . $keytime . '&keyexpert=' . $keyexpert . '&keynote=' . $keynote;
$_SESSION['login_type'] = "login.blade.treatment.php?cunique={$cunique}&id={$cid}&keydate={$keydate}&keytime={$keytime}&keyexpert={$keyexpert}&keynote={$keynote}";
?>
