...
<div class="container">
    ...
    <div class="filter-box">
        <div style="margin: auto; width: 100%; height: 80px; display: grid; grid-template-columns: repeat(3, max-content 90%); margin-bottom: 25px;">
            <div class="filter-btn-sort">
                <a href="new-filter-clinic-page.blade.php?id=<?=$cid_url?>&cunique=<?=$cunique_url?>&gender=<?=$gender?>&<?=$treatmentsString?>" style="width: 100%">
                    <button class="filter-btn" style="margin-left: 45px">
