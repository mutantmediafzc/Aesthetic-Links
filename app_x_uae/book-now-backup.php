...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        userTracker('treatment_page', $row['hook'], $row['cname']);
...
if ($result->num_rows > 0) {
    ...
    <div class="service-details-container">
        <div class="service-details">
            <p class="backBtn">
                <a href="clinic-details.blade.php?id=' . $row['hook'] . '&cunique=' . $row['cunique'] . '" style="text-decoration: none; color:inherit">               
            ...
            <div class="service-details-img-section">
                <div class="service-details-img-container">
                    ...
                    <img src="assets/images/services/' . $cserviceId . '.png">
                </div>
            </div>
            <div class="container">
            ...
            <div class="more-details-section">
                <div class="address">
                    <div style="width: 100%; display: grid; grid-template-columns: repeat(2, max-content 90%); column-gap: 5px;">
                        <div style="width: auto;" class="service-type">
                            ' . $img . '
                        </div>
                        <div style="width: 100%;">
                    ...
                    <div style="width: 100%; margin: auto;" class="service-rating">';
        ...
        echo '<br>
                    ...
                    <p style="font-size: 12px; width: 94%;">' . $row['sbio'] . '</p>
                ...
                <div class="pricing-container">
                    ...
                    <div><h4 id="orig-price" class="service-price-fee this-' . $row['discountdisplay'] .'">' . convertCurrency($row['sprice']) . ' </h4></div>
                </div>
                </div>
                ...
                <div style="position:fixed; left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
                    <div class="booking-btn-container">
                        <div><a href="book-now-treatment.php?cunique=' . $row['cunique'] . '&id=' . $cserviceId . '"><button class="book-now">Book now</button></a></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function copyCurrentUrl() {
        ...
        tooltip.style.top = iconRect.top + 25 + "px"
...
<script>
    ...
    function openCalendar() {
        var img = new Image()
        img.src = `user-tracker.php?action=userTracker&field=calendar_page&clinicId=${clinicId}&clinic=${clinicName}`
        
        console.log('calendar', cname);
    ...
    function openTime() {
        var img = new Image()
        img.src = `user-tracker.php?action=userTracker&field=time_page&clinicId=${clinicId}&clinic=${clinicName}`
