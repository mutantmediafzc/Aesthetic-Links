    ...
    <tr>
      <td style="background-color: #0D2748;">
        <table role="presentation" cellspacing="0" cellpadding="0" width="100%" style="height: 100%;">
          <tr>
            <td>
              <img style="width:60%; margin-top: 40px;" src="https://aestheticlinks.com/app-adas/views/assets/images/logo-anl-w.png" alt="Aesthetic Links Logo"/>
            </td>
          </tr>
          <tr>
            <td style="padding: 0 24px;">
              ...
              <div style="background-color: #fff; border-radius: 20px; max-width: 600px; margin: 0 auto;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" width="100%" style="border-collapse: collapse;">
                  ...
                  <tr>
                    <td style="padding-left: 24px; font-weight: 600; color: #0D2748; font-size: 18px; margin: 0; text-align: left;"><a href="'.$clocation.'">Location</a></td>
                  </tr>
                </table>
              </div>
            </td>
