...
if ($result->num_rows > 0) {
   ...
   <div class="consultation-fee-box">
        <h5 class="service-consultation-price" style="margin-top: 10px">
            ...
            <br/><br/><p style="font-weight: 400; font-size: 12px;" class="service-description">' . $row['sbio'] . '</p>
    ...
    <div style="left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
        <div class="booking-btn-container">
            <div><a href="book-now-max.php?cunique=' . $row['cunique'] . '&id=' . $row['id'] . '"><button class="book-now">Book now</button></a></div>
