...
// Validate and query project details
	...
	<div class="service-details-section">
        <div class="service-details-section-container">
            ...
            <p class="paragraph-2">' . $avgRating . ' <i class="fa-solid fa-star" style="color: #0CB4BF; font-size: 8pt;"></i></p>
        </div>
        ...
        <div class="row">
            ...
            <div class="more-details-section">
                    <div class="address">
                        ...
                        <p class="paragraph-3">' . $row['ccity'] . ', ' . $row['ccountry'] . '</p>
...
<div class="filter-box">
    <div style="margin: auto; width: 90%; height: 100px; display: grid; grid-template-columns: repeat(3, max-content 90%); margin-bottom: 5pt;">
...
// We don't have the password or email info stored in sessions, so instead, we can get the results from the database.
    ...
    <a class="div" id="div" href="book-treatment.php?cunique=' . $row['cunique'] . '&id=' . $row['id'] . '" style=" width: 100%; text-decoration: none; cursor: pointer; color: #000;">
      <div class="services-list">
          <div class="service-img-container">
              <img src="assets/images/services/' . $row['id'] . '.png">
          </div>
    ...
    <a class="div" id="div" href="book-max.php?cunique=' . $row['cunique'] . '&id=' . $row['id'] . '" style=" width: 100%; text-decoration: none; cursor: pointer; color: #000;">
      <div class="services-list">
          <div class="service-img-container">
              <img src="assets/images/services/' . $row['id'] . '.png">
          </div>
