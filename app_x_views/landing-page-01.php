...
<body>
	...
	?>	
		<div class="content-container example">
		...
		<?php
			...
			echo				
                ...
                '<a href="clinic-details.blade.php?id=' . $row['id'] . '&cunique=' . $row['cunique'] . '" style=" width: 100%; height: auto; text-decoration: none; cursor: pointer; color: #444444;">
                    <div class="card-item">
