...
$_SESSION['login_redirection_url'] = 'book-now-treatment-discount.php?cunique=' . $cunique . '&id=' . $cid . '&date=' . $keydate . '&time=' . $keytime . '&expert=' . $keyexpert . '&note=' . $keynote;
$_SESSION['login_type'] = "login.blade.treatment2.php?keydate={$keydate}&keytime={$keytime}&keyexpert={$keyexpert}&keynote={$keynote}";
?>
