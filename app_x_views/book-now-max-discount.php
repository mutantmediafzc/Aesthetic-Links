...
<div id="discountModal" class="discountmodal">
    ...
    <div class="time-content" style=" display: grid; grid-template-columns: repeat(1, 1fr);">
        ...
        <div id="spacer-modal-two" class="spacer-modal" style="margin-bottom: 0 !important;">
            <p id="Choose-a-Time" style="margin-top: 20px; margin-bottom: 20px; margin-left: 40px;">Enter discount code</p>
        </div>
