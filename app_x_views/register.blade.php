  ...
  ?>
    ...
    <div style="width: 100%; display: grid; grid-template-columns: repeat(1, 1fr); height: max-content;">
        ...
        <div>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 30% 67%); column-gap: 3%">
                <div style="width: 100%">
                    <select class="select-code" name="mobile_code" id="countrySelect">
                        ...
                        ?>
                            <option <?php if ($row['mobile_code'] == 971): ?> <?= 'selected' ?> <?php endif; ?> value="<?= $row['mobile_code'] ?>"><?= $row['country'] . " ({$row['mobile_code']})" ?></option>
                        <?php
                                }
                            }
                        ?>
