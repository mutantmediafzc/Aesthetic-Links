...
<body>
	   ...
	   <!---- Menu End ----->
        ...
        <section class="map">
            ...
            <iframe src="https://my.atlist.com/map/42858242-a96b-4aa3-88fd-b80c84d59953?share=true" width="100%" height="400px" loading="lazy" frameborder="0" scrolling="no" allowfullscreen id="atlist-embed"></iframe>
        </section>        
	...
	<div class="control-bar">
        ...
        <div class="control-bar-container">
            <div style="width: 100%;">
                <input type="text" class="search-bar-landing" placeholder="Search for Clinics...">
            </div>
        ...
        <div class="divider"></div>
            ...
            <button class="view-all-clinics">
                <a href="landing-page-view-all.blade.php" style="font-family: 'poppinsregular'; width: 100%; text-decoration: none; color: #fff;">View all</a>
            </button>
