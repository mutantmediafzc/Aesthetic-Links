...
if ($result->num_rows > 0) {
    ...
    <div class="service-details-container">
        ...
        <div class="more-details-section">
            <div class="address">
                ...
                <div style="width: 100%; display: grid; grid-template-columns: repeat(2, max-content 90%); column-gap: 5px;">
                    <div class="gender-container" style="width: auto;">' . $img . '</div>
                    <div style="width: 100%;">
        ...
        <br class="hidden-el">
        <br class="hidden-el"/><br class="hidden-el"/>
        
        <div class="book-now-section" style="position:fixed; left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
