                                     ...
                                     <div  id="card-container" class='big-box'>
                                        <div class="card">
                                          <div class="clinic-info">
                                            <h2>Clinic Name 1</h2>
                                            <p>Location: <i class="fas fa-map-marker-alt"></i> Clinic Address</p>
                                            <p>Open Until: <i class="far fa-clock"></i> 8:00 PM</p>
                                            <p>Reviews: <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i></p>
                                            <p>Consultation Fee: <i class="fas fa-money-bill-wave"></i> 0 AED</p>
                                          </div>
