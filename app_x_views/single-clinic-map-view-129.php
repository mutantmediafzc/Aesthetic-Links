	...
	<?php
	   ...
	   <!---- Menu End ----->
        ...
        <section class="map">
            ...
            <iframe src="https://my.atlist.com/map/2573e840-7ae0-4c14-bf85-d3c05edf5d65?share=true" width="100%" height="400px" loading="lazy" frameborder="0" scrolling="no" allowfullscreen id="atlist-embed"></iframe>
        </section>      
