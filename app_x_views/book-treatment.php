            ...
            <div class="more-details-section">
                ...
                <div style="position:fixed; left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
                    <div class="booking-btn-container">
                        <div><a href="book-now-treatment-backup.php?cunique=' . $row['cunique'] . '&id=' . $cserviceId . '"><button class="book-now">Book now</button></a></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div style="margin-top: 50px;">
                    <button 
                        style="
                            ...
                            cursor: pointer;
                        "
                        onclick="window.location.href=\'book-now-treatment-backup.php?cunique='. $serviceId . '&id='. $cserviceId .'\'"
                    >
                        Book Now
                    </button>
                </div>
