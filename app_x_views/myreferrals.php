...
if ($userId) {
  $sql = "SELECT * FROM accounts WHERE referral = ?";
...
if ($result->num_rows > 0) {					
            ...
            <a href="#" style="width: 100%; text-decoration: none; cursor: pointer; color: #000;">
                <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(1, 1fr); margin: auto;">
                    ...
                    <div class="btn-text-box">
                        ...
                        <button style="width: max-content; height: max-content; margin: 0; font-size: 18px; border-style: none; -webkit-tap-highlight-color: transparent;" onclick="copyText(\'' . htmlspecialchars($row['discode']) . '\')">' . htmlspecialchars($row['discode']) . ' &nbsp; <i class="fa-regular fa-copy" style="color: #0CB4BF;"></i></button>
                    </div>
                    <div class="btn-text-box">
                        <p>Unused</p>
                    </div>
    ...
    echo '<p>No Appointments to display at the moment.</p>';
}
?>
