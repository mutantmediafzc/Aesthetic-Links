...
$_SESSION['login_redirection_url'] = 'clinic-details.blade.php?cunique=' . $cunique . '&id=' . $cid;
$_SESSION['login_type'] = "login.blade.clinic.php?cunique={$cunique}&id={$cid}";
?>
...
<form action="authenticate.bookings.php?cunique=<?=$cunique?>&id=<?=$cid?>" method="POST" class="logremember">
