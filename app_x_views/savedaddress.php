    ...
    <section class="profile-dashboard">
        <div class="your-account">
            <div style="width: 100%; height: auto;">
                <h1 style="margin: 0; padding: 0; color: #000; font-size: 48px; font-weight: 600;">My Saved Addresses</h1>
            </div>

            <div class="button-your-account">
                <a href="discover-page.blade.php" style="text-decoration: none;">
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto; border: 1px solid red;">
                        <div style="width: 100%; height: 100%;"><img src="assets/images/location.png" style="width: 45px; height: 45px;"></div>
                        <div style="text-align: left;">Waiting for Google Maps APis to initialize</div>
                    </div>
