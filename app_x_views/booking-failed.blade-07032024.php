...
// Add failed no
$service = "SELECT failed_no FROM services WHERE id =  ?";
$serviceStmt = $con->prepare($service);
$serviceStmt->bind_param("s", $service_id);
$serviceStmt->execute();
$serviceResult = $serviceStmt->get_result();

$clinicQry = "SELECT failed_no FROM clinics WHERE cunique =  ?";
...
<body>
    ...
    <section class="book-now-section" style="position:fixed; left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
        <div class="booking-btn-container">
            <a href="discover-page.blade.php"><div><button class="book-now">Go to Home Page</button></div></a>
