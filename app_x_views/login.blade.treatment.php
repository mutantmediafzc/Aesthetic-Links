...
$_SESSION['login_redirection_url'] = 'book-now-max-discount?cunique=' . $cunique . '&id=' . $cid . '&keydate=' . $keydate . '&keytime=' . $keytime . '&keyexpert=' . $keyexpert . '&keynote=' . $keynote;
$_SESSION['login_redirection_url'] = 'book-now-max-discount.php?cunique=' . $cunique . '&id=' . $cid . '&date=' . $keydate . '&time=' . $keytime . '&expert=' . $keyexpert . '&note=' . $keynote;
$_SESSION['login_type'] = "login.blade.treatment.php?keydate={$keydate}&keytime={$keytime}&keyexpert={$keyexpert}&keynote={$keynote}";
?>
...
<br><br>
  ...
  <div class="container signin">
    ...
    <br/>
      <a href="book-max.php?cunique=<?=$cunique?>&id=<?=$cid?>" style="text-decoration: underline; color:#000;">Go Back to Service</a>
  </div>
