...
$keydate = htmlspecialchars($_GET['date']);
$keytime = htmlspecialchars($_GET['time']);
$keyexpert = htmlspecialchars($_GET['expert']);
$keynote = htmlspecialchars($_GET['note']);

session_start();

$_SESSION['login_type'] = "login.incorrect.services.php?keydate={$keydate}&keytime={$keytime}&keyexpert={$keyexpert}&keynote={$keynote}";
?>
<!DOCTYPE html>
<html>
<head>
