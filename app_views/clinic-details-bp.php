...
<div class="filter-box">
    ...
    <div class="category-container">
        <div style="width: 100%; height: auto;">
            <button class="tablinks" onclick="openService(event, 'Face')" style="font-family: 'poppinsregular'"><a
                    href="#face-tab" style="text-decoration: none; color: inherit">Face</a></button>
        </div>
        <div style="width: 100%; height: auto;">
            <button class="tablinks" onclick="openService(event, 'Body')" style="font-family: 'poppinsregular'"><a
                    href="#body-tab" style="text-decoration: none; color: inherit">Body</a></button>
        </div>
        <div style="width: 100%; height: auto;">
            <button class="tablinks" onclick="openService(event, 'Health')" style="font-family: 'poppinsregular'"><a
                    href="#health-tab" style="text-decoration: none; color: inherit">Health & Wellness</a></button>
        </div>
    </div>
</div>
...
<script>
    function openService(evt, serviceName) {
        if(serviceName == 'body') {
            document.querySelector('#body-tab').scrollIntoView({ behavior: 'smooth' });
        }
