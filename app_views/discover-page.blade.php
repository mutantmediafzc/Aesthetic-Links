...
<section style="margin: auto; width: 100%; margin-top: 5%;">
    <div style="margin: auto; width: 90%; height: auto;">
        ...
        <div class="wrapper">
            ...
            $stmt = "SELECT * FROM clinics WHERE approval = 'approved' AND is_new = 1 AND ccountry ='Switzerland'";
            ...
            <div class="slider-container">
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        ...
                        // Define your SQL query to select all projects
                        $stmt = "SELECT * FROM services WHERE approval = 'approved' AND discountdisplay ='discountdisplay' AND scountry ='Switzerland'";
            ...
            <div class="slider-container">
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        ...
                        // Define your SQL query to select all projects
                        $stmt = "SELECT * FROM services WHERE approval = 'approved' AND scat ='Face' AND scountry ='Switzerland'";
            ...
            <div class="slider-container">
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        ...
                        // Define your SQL query to select all projects
                        $stmt = "SELECT * FROM services WHERE approval = 'approved' AND scat ='Body' AND scountry ='Switzerland'";
            ...
            <div class="slider-container">
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        ...
                        // Define your SQL query to select all projects
                        $stmt = "SELECT * FROM services WHERE approval = 'approved' AND scat ='Health' AND scountry ='Switzerland'";
            ...
            <div class="slider-container">
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        ...
                        $stmt = "SELECT * FROM services WHERE approval = 'approved' AND is_special = 1 AND scountry ='Switzerland'";
