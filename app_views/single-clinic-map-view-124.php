	...
	<?php
	   ...
	   <!---- Menu End ----->
        ...
        <section class="map">
            ...
            <iframe src="https://my.atlist.com/map/282a6110-037c-4b2a-ba0d-8c03ed314944?share=true" width="100%" height="400px" loading="lazy" frameborder="0" scrolling="no" allowfullscreen id="atlist-embed"></iframe>
        </section>        
