...
if ($result->num_rows > 0) {
    ...
    <div class="more-details-section">
        <div class="address">
            ...
            <div style="width: 100%; margin: auto;">
                <a href="service-reviews.php?cunique=' . $row['cunique'] . '&id=' . $row['id'] . '" style="text-decoration: none; color: #212121;"><p class="service-rating">' . $avgRating . ' <i class="fa-solid fa-star" id="service-star" style="color: #0CB4BF;"></i>';
   ...
   <div class="consultation-fee-box">
        <h5 class="service-consultation-price" style="margin-left:25px;">
            ...
            <br/><br/><p style="font-weight: 400; font-size: 12px; width: 94%;">' . $row['sbio'] . '</p>
    ...
    <div style="left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
        <div class="booking-btn-container">
            <a style="
                text-decoration: none;
                display: flex;
                justify-content: center;" href="#"><button class="book-now" onclick="openCalendar()">Book now</button></a>
