...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="box2">
        <div class="box1">
            <iframe src="https://www.youtube.com/embed/9wVPXBg4Qxc?rel=0&amp;autoplay=1&mute=1&loop=1" width="100%" height="90%" frameborder="0" style="border-radius: 10px;"></iframe>
        </div>
        <div style="width: 100%;">
            <p class="paragraph">Погрузитесь в нашу историю, возможности и присоединяйтесь к сообществу Aesthetic Links!</p>
        </div>
    </div>
    ...
    <div style="position:fixed; left:0px; bottom:0px; height:auto; width:100%; display: grid; grid-template-columns: repeat(1, 1fr);">
        <div class="booking-btn-container">
            ...
            <p><a style="text-decoration:none; color: #000;" href="onboarding1.blade.php">< Go Back</a></ ></p>    
              <a href="https://ru.aestheticlinks.com/app/views/landing-page.blade.php" style="text-decoration: none;"><button class="book-now" style="font-family: 'Poppins', sans-serif;">Пропустить</button></a>
            </div>
