...
if ($clinicId) {
	...
	<div class="service-details-section">
        <div class="service-details-section-container">
            ...
            <p class="paragraph-2" style="margin-top:2.4px;">' . $avgRating . ' <i class="fa-solid fa-star" style="color: #0CB4BF; font-size: 8pt;"></i></p>
    ...
    <div class="more-details-section">
        <div class="address">
            ...
            <div style="width: 100%; display: grid; grid-template-columns: repeat(1, 1fr);">
                <div style="width: 100%;">
                    <p class="paragraph-3" style="display:inline-block">'. $imgClinic . ' ' . $row['ctype'] . '</p>
                </div>
            </div>
...
// We don't have the password or email info stored in sessions, so instead, we can get the results from the database.
    ...
    <a class="div" id="div" href="book';

                    if ($treatmentType === 'consultation') {
                        echo '.php?cunique=';
                    } else if ($treatmentType === 'treatment') {
                        echo '-treatment.php?cunique=';
                    } else if ($treatmentType === 'maxservice') {
                        echo '-max.php?cunique=';
                    }

                    echo $row['cunique'] . '&id=' . $row['id'] . '" style=" width: 100%; text-decoration: none; cursor: pointer; color: #000;">
      <div class="services-list">
          ...
          <div class="service-details-list">
              ...
              <div style="width: 90%; margin: auto; margin-top: 4px;">
                  <p class="service-rating">' . $avgRating . ' <i class="fa-solid fa-star" id="service-star"></i>';
...
// Display different duration based on treatment type
                    if ($treatmentType === 'consultation') {
                        echo $row['stime'];
                    } else {
                        echo $row['sduration'];
...
// Display different prices based on treatment type
...
// Append specific treatment type to the URL
                    if ($treatmentType === 'consultation') {
                        echo '.php?cunique=';
                    } else if ($treatmentType === 'treatment') {
                        echo '-treatment.php?cunique=';
...
// We don't have the password or email info stored in sessions, so instead, we can get the results from the database.
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    //Add a condition to display different content based on treatment_type
                    // Check if $result is empty and display a message if so
                    if (empty($result)) {
                        echo '<p>No service to display at the moment.</p>';
                    } else {
                        // Determine treatment type and echo specific content accordingly
                        echo '
    <div data-show="' . $row['genderid'] . '" class="item" data-text="' . $row['sname'] . '">
    ...
    <a class="div" id="div" href="';
                        ...
                        if ($treatmentType === 'consultation') {
                            echo 'book.php?cunique=';
                        } else if ($treatmentType === 'treatment') {
                            echo 'book-treatment.php?cunique=';
                        } else if ($treatmentType === 'maxservice') {
                            echo 'book-max.php?cunique=';
                        }
      ...
      <div class="services-list">
          ...
          <div class="service-details-list">
              ...
              <div style="margin: auto; width: 90%; display: grid; grid-template-columns: repeat(2, max-content 30%); column-gap: 20px; margin-bottom: 8.px; margin-top: -3px;">
                  <h3 class="service-item-title" style="max-width:240px;">' . $row['sname'] . '</h3>
              </div>
...
<script>
    ...
    const textToShare = "Check out this awesome clinic on Aesthetic Links: https://aestheticlinks.com/app/views/clinic-details.blade.php?id=" + id + "&cunique=" + cunique;
