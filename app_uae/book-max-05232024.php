        ...
        <div class="service-details">
            ...
            <div class="service-details-section">
                ...
                <div class="service-icons">
                    ...
                    <div class="icons" id="share-service" onclick="copyCurrentUrl()" style="cursor: pointer;">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="height: 18px;">
                    ...
                    <form id="addToFavoritesForm" action="add-to-favorites.php" method="POST">
                        ...
                        <input type="hidden" value="book-max" name="type">
                        <div class="icons" onclick="addToFavorites(event)" style="cursor: pointer;">
            ...
            <div style="left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
                <div class="booking-btn-container">
                    <a style="
                        text-decoration: none;
                        display: flex;
                        justify-content: center;" href="book-now-max.php?cunique=' . $row['cunique'] . '&id=' . $cserviceId . '"><button class="book-now">Book now</button></a>
            ...
            <div style="margin-top: 50px;">
                ...
                <button 
                    style="
                        ...
                        cursor: pointer;
                    "
                    onclick="window.location.href=\'book-now-max.php?cunique='. $serviceId . '&id='. $cserviceId .'\'"
                >
                    Book Now
                </button>
                <button 
