...
$stmt = $con->prepare('INSERT INTO reviews (user_id, product_id, rating, content, cname, sname) VALUES (?, ?, ?, ?, ?, ?)');

// Bind parameters and execute the statement
$stmt->bind_param('ssssss', $user_id, $product_id, $rating, $content, $cname, $sname);
$stmt->execute();
