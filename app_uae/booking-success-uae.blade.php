...
<head>
 ...
 <script>
    gtag("event", "purchase", {
        ...
        tax: 0,
        shipping: 0,
        currency: "getthecurrency",
        coupon: "<?= $voucher ?>", 
        items: [
            {
                item_id: "<?= $service_id ?>", 
                item_name: "<?= $keysname ?>", 
                affiliation: "<?= $keycname ?>",
                coupon: "", 
                discount: 0, 
                index: 0,
                item_brand: "blank",
                ...
                item_category4: "blank",
                item_category5: "blank",
                item_list_id: "blank",
                item_list_name: "blank",
                item_variant: "blank",
                location_id: "blank",
                price: "<?= $keysprice ?>", // Assuming keysprice is the variable containing the price of the service
                quantity: 1
            }
        ]
    });
