	...
	<?php
	   ...
	   <!---- Menu End ----->
        ...
        <section class="map">
            ...
            <iframe src="https://my.atlist.com/map/54905a09-6cbe-4b1c-bf3c-30d9a21377cb?share=true" width="100%" height="400px" loading="lazy" frameborder="0" scrolling="no" allowfullscreen id="atlist-embed"></iframe>
        </section>        
