...
<style>
    ...
    .fixed-search-bar {
        ...
        width: 100%;
        z-index: 1000;
        background-color: #fff; /* Ensure the background covers content behind it */
        ...
        <section class="map-view" id="map-section">
            <div class="clinic-img-container">
                ...
                <div class="overlay-black" style="z-index: 0;">
                    <img src="assets/images/map-view.jpg" style="width: 100%; height: 100%; object-fit: cover; border-radius: 10px;">
                </div>
            </div>
        </section>
    </a>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-rating">
                            ...
                            <?php } else { ?>
                                    <span class="reviews" style="margin-right: 0; color: #0CB4BF">New</span>
                            <?php } ?>
                            <div class="vertical-line"></div>
                            <span class="gender"><?php echo $imgClinic ?> <?php echo $row['ctype'] ?></span>
                        </div>
                        <p>
                            <?php
                            $bio = $row['cbio'];
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (cards.length >= 3) {
            // Only add the scroll event listener if there are 3 or more cards
            document.addEventListener('scroll', function() {
                ...
                if (window.scrollY > mapSectionHeight) {
