...
if (isset($_SESSION['loggedin'])) {
    $userId = $_SESSION['id'];
    $userFavorite = "SELECT id FROM account_favorites WHERE account_id = '$userId' AND service_id = '$cserviceId'";

    $isFavorite = $con->query($userFavorite);
}
                ...
                <div class="service-details">
                    ...
                    <div class="service-details-section">
                        ...
                        <div class="service-icons">
                            ...
                            <form id="addToFavoritesForm" action="add-to-favorites.php" method="POST">
                                <input type="hidden" value="'. $serviceId .'" name="cunique">
                                <input type="hidden" value="'. $cserviceId .'" name="id">
                    ...
                    <div class="more-details-section">
                        ...
                        <h5 class="service-consultation-price">
                            ...
                            <span style="font-weight: 400; margin-left: 0px;" class="display-none"><i class="fa-solid fa-stopwatch"></i> ' . $row['stime'] . '</span>
                            <br class="display-none" /><br class="display-none" /><p style="font-weight: 400; font-size: 12px;">' . $row['sbio'] . '</p>
                        </h5>
                        <br>
                    ...
                    <div style="left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
                        <div class="booking-btn-container">
                            ...
                            href="book-now.php?cunique=' . $row['cunique'] . '&id=' . $cserviceId . '"><button class="book-now">Book a Consultation</button></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div style="padding: 15px 20px;">
                        ...
                        <div style="margin-top: 50px;">
                            ...
                            <button style="
                                    ...
                                    cursor: pointer;
                                "
                                onclick="window.location.href=\'book-now.php?cunique='. $serviceId . '&id='. $cserviceId .'\'"
                            >
                                Book Consultation
                            </button>
                        </div>
