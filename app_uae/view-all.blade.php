...
<div class="control-bar">
        ...
        <div class="landing-page-filters">
            ...
            <div>
                ...
                <div id="myDropdown" class="dropdown-content radio-container">
                    ...
                    <input type="radio" name="sort" id="sort-asc" value="asc" checked class="checkboxSort">

                    <br>

                    <label class="sortingLabel" for="sort-asc">Sort by names (A-Z)</label>
                    <input type="radio" name="sort" id="sort-asc" value="asc" value="desc" class="checkboxSort">

                    <br>

                    <label class="sortingLabel" for="sort-desc">Sort by names (Z-A)</label>
                    <input type="radio" name="sort" id="sort-desc" value="desc" class="checkboxSort">

                    <br>

                    <label class="sortingLabel" for="sort-asc">Price Low to High</label>
                    <input type="radio" name="sort" id="" value="" value="desc" class="checkboxSort">

                    <br>

                    <label class="sortingLabel" for="sort-asc">Price High to Low</label>
                    <input type="radio" name="sort" id="" value="" value="desc" class="checkboxSort">
                        ...
                        <div class="text-container">
                            ...
                            <div class="second-line">
                                ...
                                <div class="money-icon-container">
                                    <div style="display: flex; align-items: center;"><i class="fa-solid fa-dollar-sign" id="money-icon-2"></i></div>
                                    <div style="display: flex; align-items: center;"><i class="fa-solid fa-dollar-sign" id="money-icon-2"></i></div>
                                    <div style="display: flex; align-items: center;"><i class="fa-solid fa-dollar-sign" id="money-icon"></i></div>
                                </div>

                            </div>
                            <!--<div style="width: 100%;"><p class="paragraph-2">' . $row['specialty'] . '</p></div>-->
                            <div style="width: 100%; height: auto;"><div class="solid"></div></div>
                        </div>
                    </div>
                </a>
    ...
    <div id="myForm" class="form">
        ...
        <div class="form-content">
            ...
            <h1 style="font-size: 16px;">Request a clinic</h1>

            <div class="form-container-box">
                <label for="first-name">Clinic Name:</label><br>
                <input type="text" id="first-name" name="clinic-name" placeholder="Clinic name" style="text-indent: 10px;"><br><br>
                ...
                <input type="text" id="address" name="address" placeholder="Specify" style="text-indent: 10px;"><br>
            </div>
    ...
    <button class="view-all-clinics">
        <a onclick="hideMap()" style="font-family: 'poppinsregular'; width: 100%; text-decoration: none; color: #fff;">View all</a>
    </button>
