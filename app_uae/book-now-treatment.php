...
$stmt2 = $con->prepare("UPDATE services SET book_now_clicks = ? WHERE id = ?");
...
//     header('Location: login.blade.treatment2.php?cunique=' . $cunique . '&id=' . $id);
//     exit;
// }
?>
...
<div id="calendarModal" class="calendarmodal">
    ...
    <div class="time-content" style=" display: grid; grid-template-columns: repeat(1, 1fr);">
        ...
        <div style="color: #DC143C; width: 100%; display: none; width: 90%; margin: auto;" id="error_message">
...
if ($result->num_rows > 0) {
    ...
    <div class="service-details-section" style="margin-top: 10px">
        <div class="service-name-box" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <p class="service-location" style="font-size: 12px; width: 20%!important; text-align: right; align-items: center;">
     ...
     <div class="more-details-section" style="margin-top: 0">
        ...
        echo '</div>
                <div style="width: 100%; display: flex; align-items: center;">
                    ...
                    <p class="service-gender" style="margin: 0; font-size: 12px; color: #9a9c9d; font-weight: 100;">
    ...
    <div style="left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
        <div class="booking-btn-container">
            ...
            <div><button class="book-now" style="border: none; font-size: 15px;" onclick="openCalendar()">Book Now</button></div>
        </div>
...
<script>
    ...
    function confirmSched() {
        // window.location.href = 'create-checkout-session-uae.php';

        var form = document.createElement('form');
        form.setAttribute('method', 'get');
        form.setAttribute('action', 'book-now-treatment-discount.php');
