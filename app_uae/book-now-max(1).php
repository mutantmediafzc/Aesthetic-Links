...
$stmt = $con->prepare('SELECT username, email, userunique, userlevel, profilelevel, discode FROM accounts WHERE id = ?');
// In this case we can use the account ID to get the account info.
$stmt->bind_param('i', $_SESSION['id']);
$stmt->execute();
$stmt->bind_result($username, $email, $userunique, $userlevel, $profilelevel, $discode);
$stmt->fetch();
$stmt->close();
...
<div id="calendarModal" class="calendarmodal">
    ...
    <div class="time-content" style=" display: grid; grid-template-columns: repeat(1, 1fr);">
        ...
        <div style="color:#DC143C;width:100%;display:none; width: 90%; margin: auto;" id="error_message">
            please select date after one day from today
        </div>
        <div class="spacer-modal">
            <hr class="solid">
        </div>
...
<!-- ----------------------------discount modal end------------------------ -->
                        ...
                        <div id="discountModal" class="discountmodal">
                            ...
                            <div class="time-content" style=" display: grid; grid-template-columns: repeat(1, 1fr);">
                                ...
                                <div class="spacer-modal" style="display:flex; justify-content: center; align-items: center;">
                                    <h1 style="margin-top: 20px;">Enter discount code</h1>
                                ...
                                <div class="time">
                                    <input type="text" id="discountCode" name="discountcode"  oninput="couponcheck()"  placeholder="" style="text-indent: 10px; border-radius: 8px;">
                                </div>
                    ...
                    <div class="expert-radio-section">
                        <div class="py">
                            ...
                            <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 95% 5%);">
                                <div>
                                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 20% 75%); column-gap: 5%;">
                                        <div style="width: 100%; height: 100%;"><img src="assets/images/experts/'.$row['expert_id_2'].'.jpg" alt="" class="doc-img"></div>
                            ...
                            <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 95% 5%);">
                                <div>
                                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 20% 75%); column-gap: 5%;">
                                        <div style="width: 100%; height: 100%;"><img src="assets/images/experts/'.$row['expert_id_3'].'.jpg" alt="" class="doc-img"></div>
...
if ($result->num_rows > 0) {
	...
	<input type="hidden" id="discode" name="discode" value="'.$discode.'" />
    ...
    <div class="more-details-section">
        ...
        <div class="pricing-container">
            ...
            <div><h4 class="service-price-fee">' . convertCurrency($row['sprice']) . ' </h4></div>
        </div>
    </div>
...
<script>
    ...
    function couponcheck(){
        ...
        var discode=document.getElementById("discode").value;
        if(discode==null){
