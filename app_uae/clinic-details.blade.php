        ...
        <div class=" sortable-container">
            ...
            <div id="face_tab" class="" style="margin: auto;  width: 100%; height: max-content; overflow-x: hidden;">
                ...
                ?>
                        ...
                        <!--Variant 1-->
                        <a href="<?= $treatmentUrl . $row['cunique'] . '&id=' . $row['id'] . '&cid=' . $clinicId ?>" class="detail-page-cards " data-text="<?= $row['sname'] ?>" data-show="<?= $row['genderid'] ?>">
            ...
            <div id="body_tab" class="example " style="margin: auto;  width: 100%; height: max-content; overflow-x: hidden;">
                ...
                if ($rowCount > 0) {
                    foreach ($rows as $k => $row) {
                        ...
                        // Body
                ?>
                        <a href="<?= $treatmentUrl . $row['cunique'] . '&id=' . $row['id'] . '&cid=' . $clinicId ?>" class="detail-page-cards " data-show="<?= $row['genderid'] ?>" data-text="<?= $row['sname'] ?>">
