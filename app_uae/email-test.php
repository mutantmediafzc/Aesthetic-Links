              ...
              <div style="background-color: #fff; border-radius: 20px; max-width: 600px; margin: 0 auto;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" width="100%" style="border-collapse: collapse;">
                  ...
                  <tr>
                    ...
                    <td style="padding-right: 24px; padding-bottom: 24px; font-weight: 600; color: #46AFB4; font-size: 18px; margin: 0; text-align: right;"><a style="color: #46AFB4; text-decoration: none;" href="'.$clocation.'">Click Here</a></td>
                  ...
                  <tr>
                    <td style="padding-left: 24px; padding-bottom: 24px; font-weight: 600; color: #0D2748; font-size: 18px; margin: 0; text-align: left;"><a style="color: #46AFB4; text-decoration: none;"
                    href="https://www.google.com/calendar/render?action=TEMPLATE&text='.$keysname.'+Booking&details=For+'.$expert_name.'%2C+'.$keycname.'%2C+'.$type.'&location='.$clocation.'&dates=20240330T075300Z%2F20240328T075300Z">Add to Google Calendar</a></td>
