...
if ($result->num_rows > 0) {
    ...
    <input type="hidden" id="clinic_id" name="" value="'.$serviceId.'" />
        ...
        <div class="service-details">
            ...
            <div class="service-details-section">
                ...
                <div class="service-icons">
                    ...
                    <form id="addToFavoritesForm" action="add-to-favorites.php" method="POST">
                        ...
                        <input type="hidden" value="book-treatment" name="type">
            ...
            <div class="more-details-section">
                ...
                <div class="pricing-container">
                    ...
                    <div><h4 class="service-price-fee this-' . $row['discountdisplay'] .'">' . convertCurrency($row['sprice']) . ' </h4></div>
                </div>
                </div>
                ...
                <div style="margin-top: 50px;">
                    <button 
                        style="
                            ...
                            cursor: pointer;
                        "
                        onclick="window.location.href=\'book-now-treatment.php?cunique='. $serviceId . '&id='. $cserviceId .'\'"
                    >
                        Book Now
                    </button>
                </div>
