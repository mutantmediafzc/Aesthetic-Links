...
<!-- End Google Tag Manager (noscript) -->
	   ...
	   <!---- Menu End ----->
    <button class="back-btn" style="        position: fixed;
        left: 5%;
        margin-top: 5%;
        width: 35pt;
        height: 35pt;
        ...
        <section class="map">
            ...
            <iframe width="100%" height="300" src="https://maphub.net/embed/330634?autoplay=1" frameborder="0" allow="geolocation"></iframe>
            <!---  <iframe src="https://my.atlist.com/map/2802cfb6-c6ef-4bfd-9560-5f26686873b2?share=true" width="100%" height="400px" loading="lazy" frameborder="0" scrolling="no" allowfullscreen id="atlist-embed"></iframe> --->
        </section>
    ...
    <button class="view-all-clinics">
        <a href="landing-page.blade.php" style="font-family: 'poppinsregular'; width: 100%; text-decoration: none; color: #fff;">Back to list view</a>
    </button>
