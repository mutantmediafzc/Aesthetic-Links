...
<!-- End Google Tag Manager (noscript) -->
            ...
            <div class="button-your-account">
				...
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        <div class="btn-img-box"><img src="assets/images/user.png"></div>
    ...
    <!--        <div class="button-your-account">-->
    <!--            <a href="savedaddress.php" style="text-decoration: none;">-->
				<!--<button>-->
    <!--                <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">-->
    <!--                    <div class="btn-img-box"><img src="assets/images/location.png"></div>-->
    <!--                    <div class="btn-text-box"><p>Saved Address</p></div>-->
    <!--                </div>-->
    <!--                <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>-->
    ...
    <!--        </div>-->
            ...
            <div class="button-your-account">
				...
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        <div class="btn-img-box"><img src="assets/images/bell.png"></div>
                        <div class="btn-text-box"><p>Notifications</p></div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>
            ...
            <div class="button-your-account">
				...
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        <div class="btn-img-box"><img src="assets/images/appointment.png"></div>
            ...
            <div class="button-your-account">
                <a href="myfavorites.php" style="text-decoration: none;">
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        <div class="btn-img-box"><img src="assets/images/heart.png"></div>
                        <div class="btn-text-box"><p>My Favorites</p></div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>
            ...
            <div class="button-your-account">
                <a href="myreferrals.php" style="text-decoration: none;">
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        <div class="btn-img-box"><img src="assets/images/referral.png"></div>
                        <div class="btn-text-box"><p>My Referrals</p></div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>
            ...
            <div class="button-your-account">
				...
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        <div class="btn-img-box"><img src="assets/images/support.png"></div>
    ...
    <section class="profile-dashboard">
        <div class="your-account">
            ...
            <div class="button-your-account">
				...
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        <div class="btn-img-box"><img src="assets/images/internet.png"></div>
            ...
            <div class="button-your-account">
				...
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        <div class="btn-img-box"><img src="assets/images/location.png"></div>
                        <div class="btn-text-box"><p>City</p></div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>
            ...
            <div class="button-your-account">
				...
				<button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        <div class="btn-img-box"><img src="assets/images/currency.png"></div>
            ...
            <div class="button-your-account">
                <button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        ...
                        <div class="btn-text-box"><p><a style="width: 100%; text-decoration: none; color:#000; cursor: pointer;" href="legal-terms-and-conditions.blade.php">Terms and Conditions</a></p></div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>
            ...
            <div class="button-your-account">
                <button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        ...
                        <div class="btn-text-box"><p><a style="width: 100%; text-decoration: none; color:#000; cursor: pointer;" href="legal-privacy-policy.blade.php">Privacy Policy</a></p></div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>
            ...
            <div class="button-your-account">
                <button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        ...
                        <div class="btn-text-box"><p><a style="width: 100%; text-decoration: none; color:#000; cursor: pointer;" href="legal-cancellation.blade.php">Cancellation and Reschedule Policy</a></p></div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>
            ...
            <div class="button-your-account">
                <button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        ...
                        <div class="btn-text-box"><p><a style="width: 100%; text-decoration: none; color:#000; cursor: pointer;" href="legal-cookie-policy.blade.php">Cookie Policy</a></p></div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>
            ...
            <div class="button-your-account">
                <button>
                    <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(2, 10% 90%); column-gap: 2%; margin: auto;">
                        ...
                        <div class="btn-text-box"><p><a style="width: 100%; text-decoration: none; color:#000; cursor: pointer;" href="legal-rewards.blade.php">Rewards and Referrals</a></p></div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="margin: auto; color: #0CB4BF;"></i>
