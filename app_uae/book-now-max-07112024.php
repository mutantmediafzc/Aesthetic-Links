...
if ($result->num_rows > 0) {
   ...
   <div class="service-details-section" style="margin-top: 10px">
        <div class="service-name-box" style="display: flex; justify-content: space-between; align-items: center;">
            <h3 class="service-title" style="font-size: 16px; margin: 0;">' . $row['sname'] . '</h3>
            <p class="service-location" style="font-size: 10px; width: 20%!important; text-align: right; align-items: center;">
                <i class="fa-solid fa-stopwatch" style="margin-right: -2px;"></i> ' . $row['stime'] . '
            </p>
        </div>
    </div>
   ...
   <div class="more-details-section" style="margin-top: 0">
        ...
        if ($row['ratings_count'] >= 10) {
            echo '<a href="service-reviews.php?cunique=' . $row['cunique'] . '&id=' . $row['id'] . '" style="text-decoration: none; color: #212121;"><span class="service-rating" style="font-size: 12px;">' . $avgRating . ' <i class="fa-solid fa-star" id="service-star" style="color: #0CB4BF;"></i> <u>'. $row['ratings_count'] . ' reviews</u></span></a>';
        } else {
            echo '<a href="service-reviews.php?cunique=' . $row['cunique'] . '&id=' . $row['id'] . '" style="text-decoration: none; color: #212121;"><span class="service-rating" style="font-size: 12px;">' . $avgRating . ' <i class="fa-solid fa-star" id="service-star" style="color: #0CB4BF;"></i></span></a>';
        }

        echo '</div>
                <div style="width: 100%; display: flex; align-items: center;">
                    <div class="vertical-line"></div>
                    <p class="service-gender" style="margin: 0; font-size: 12px;">
        ...
        <div class="pricing-container">
            ...
            <div><h4 class="service-price-fee" style="font-size: 18px">' . convertCurrency($row['sprice']) . '</h4></div>
        </div>
    </div>
   ...
   <div class="consultation-fee-box" style="margin-top: 5px;">
        <h5 class="service-consultation-price" style="margin-left:20px; font-size: 11px; font-weight: normal;">
            Consultation fee (' . $row['stime']  . ' min)<br>
    ...
    <div class="subcat" style="margin-top: 20px;">
        <div style="width: 100%;">
        <button disabled style="background-color: #e7e7e7; border: none; border-radius: 7px; width: auto; height: auto; padding: 4px 8px; min-width: 64px; min-height: 24px; color: #b0b0b0; font-size: 10px;">
            '. $row['subcat'] .'
        </button>
        </div>
        <p style="font-size: 12px; margin-top: 5px">'. $row['sbio'] .'</p>
    </div>
    ...
    <div style="left:0px; bottom:0px; height:auto; width:100%; display: flex; justify-content: center;">
        <div class="booking-btn-container">
            <a style="
                text-decoration: none;
                display: flex;
                justify-content: center;" href="#"><button class="book-now" style="border: none; font-size: 14px;" onclick="openCalendar()">Book now</button></a>
    
            <div style="width: 100%; height: auto; display: grid; grid-template-columns: repeat(3, 45% 10% 45%);">
                <div style="width: 100%; margin: auto;">
                    <hr class="solid" style="border-color: #e7e7e7e7">
                </div>
                <div style="width: 100%; margin: auto;">
                    <p class="service-gender" style="text-align: center;">OR</p>
                </div>
                <div style="width: 100%; margin: auto;">
                    <hr class="solid" style="border-color: #e7e7e7">
                </div>
            </div>
            ...
            <a href="book-now.php?cunique=' . $row['cunique'] . '&id=' . $cserviceId . '">
                <button style="width: 100%; height: auto; margin: 0; padding: 0; border-style: none; background-color: transparent;">
                    <p class="service-gender" style="color: #0C1E36; font-size: 16px; font-weight: bold"><u>Book consultation</u></p>
                </button>
                </a>
            </div>
