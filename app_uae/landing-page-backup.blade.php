...
<div class="control-bar">
        ...
        <div class="landing-page-filters">
            ...
            <div>
                ...
                <div id="myDropdown" class="dropdown-content radio-container">
                    ...
                    <input type="radio" name="sort" id="top-rated" value="top-rated" value="desc" class="checkboxSort">
    ...
    <div class="content-container example div-container">
        <h1 class="coming-soon-txt" style="font-weight: bold; margin-bottom: 0; margin-top: 10px; !important; height: 28px;"><img style="height:25px; margin-right:2px;" src="assets/images/2.png"><span style="position: relative; top: -5px;">Below are Dubai's best clinics</span></h1>
        <p class="coming-soon-p" style="font-size: 10px !important; margin-bottom: 0;">Learn more about our selection process on the <a style="color: #0CB4BF; text-decoration: none" href="discover-page.blade.php">discover section</a> </p>
        ...
        <div class="card-item">
            ...
            <div class="text-container">
                ...
                <div class="second-line">
                    ...
                    <div><p class="paragraph-2" style="color: #0CB4BF;">' . $avgRating;

                if ($row['total_reviews'] >= 10) {
                    echo ' <i class="fa-solid fa-star" id="star"></i>&nbsp; <span style="color: #212121;"><u>' . $row['total_reviews'] . ' reviews</u></span>';
                }
