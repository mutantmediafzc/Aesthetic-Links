...
$_SESSION['login_redirection_url'] = 'book-now-discount.php?cunique=' . $cunique . '&id=' . $cid . '&keydate=' . $keydate . '&keytime=' . $keytime . '&keyexpert=' . $keyexpert . '&keynote=' . $keynote;
$_SESSION['login_type'] = "login.blade.service.php?cunique={$cunique}&id={$cid}&keydate={$keydate}&keytime={$keytime}&keyexpert={$keyexpert}&keynote={$keynote}";
?>
...
<body>
  ...
  <form action="authenticate.service.php?cunique=<?= $cunique ?>&id=<?= $cid ?>" method="POST" class="logremember">
    ...
    <div class="register-container">
      ...
      <a href="reset-password-email.blade.php" style="color: #0CB4BF; text-decoration: none; font-weight: 500; width: max-content; float: right">
        <p class="paragraph-btn">Forgot Password?</p>
      </a>
